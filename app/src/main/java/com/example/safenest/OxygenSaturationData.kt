...
import com.example.safenest.databinding.FragmentOxygenSaturationDataBinding
import com.google.android.material.bottomsheet.BottomSheetBehavior

class OxygenSaturationData : Fragment() {
    private lateinit var binding: FragmentOxygenSaturationDataBinding
    private lateinit var bottomSheetBehavior: BottomSheetBehavior<View>
    private lateinit var header: TextView
    private lateinit var maincontainer: FrameLayout
    private  lateinit var button: ImageButton
    private lateinit var btnSaveOxygenSaturation: Button
    private lateinit var oDate: EditText
    private lateinit var o_data: EditText
    ...
    override fun onCreateView(
        ...
        binding= FragmentOxygenSaturationDataBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button = view.findViewById(R.id.addRowsOxygenSaturation)
        btnSaveOxygenSaturation = view.findViewById(R.id.btnSaveOxygenSaturation)
        oDate =view.findViewById<EditText>(R.id.txtDate)
        o_data = view.findViewById<EditText>(R.id.txtBP)
        ...
        btnSaveOxygenSaturation.setOnClickListener{
            bottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED

            //TODO ADD CODE HERE TO SAVE THE INPUT TO THE DATABASE
            Toast.makeText(requireContext(), "${o_data.text.toString()} ${oDate.text.toString()}", Toast.LENGTH_SHORT).show()
            dbHelper.insertOxygenSat(oDate.text.toString(), o_data.text.toString().toInt(), dbHelper.fetchUserId())
            displayData(view)
        }
    ...
    private fun displayData(view: View) {
        val bodyTempData =
            dbHelper.fetchUserId()?.let { dbHelper.getOxygenSat(it) } // Fetch the data
        ...
        headerBloodPressure.text = "Oxygen Saturation"
        ...
        if (bodyTempData != null) {
            for (record in bodyTempData) {
                ...
                bloodPressureTextView.text = record.oxygen.toString()
