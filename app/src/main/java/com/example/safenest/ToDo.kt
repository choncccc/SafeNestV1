...
import com.example.safenest.databinding.FragmentToDoBinding
...
class ToDo : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button = view.findViewById(R.id.addTODO)
        btnSaveTODO = view.findViewById(R.id.btnSaveTODO)
        date = view.findViewById(R.id.txtTodoDate)
        details = view.findViewById(R.id.txtTodo)
        ...
        btnSaveTODO.setOnClickListener{
            ...
            dbHelper.insertTodo(date.text.toString(), details.text.toString(), dbHelper.fetchUserId())
        }
    ...
    private fun displayData(view: View) {
        val todoData = dbHelper.fetchUserId()?.let { dbHelper.getTodo(it) } // Fetch the data
