...
import com.example.safenest.databinding.FragmentBloodSugarLevelDataBinding
import com.google.android.material.bottomsheet.BottomSheetBehavior

class BloodSugarLevelData : Fragment() {
    private lateinit var binding: FragmentBloodSugarLevelDataBinding
    private lateinit var bottomSheetBehavior: BottomSheetBehavior<View>
    private lateinit var header: TextView
    private lateinit var maincontainer: FrameLayout
    private  lateinit var button: ImageButton
    private lateinit var btnSaveBS: Button
    private lateinit var bsDate: EditText
    private lateinit var bs_data: EditText
    ...
    override fun onCreateView(
        ...
        binding= FragmentBloodSugarLevelDataBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button = view.findViewById(R.id.addRowsBS)
        btnSaveBS = view.findViewById(R.id.btnSaveBS)

        bsDate = view.findViewById<EditText>(R.id.txtDate)
        bs_data = view.findViewById<EditText>(R.id.txtBP)
        displayData(view)
        ...
        btnSaveBS.setOnClickListener{
            bottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED

            //ADD CODE HERE TO SAVE THE INPUT TO THE DATABASE
            Toast.makeText(requireContext(), "${bs_data.text.toString()} ${bsDate.text.toString()}", Toast.LENGTH_SHORT).show()
            dbHelper.insertBloodSugar(bsDate.text.toString(), bs_data.text.toString().toInt(), dbHelper.fetchUserId())
            displayData(view)
        }
    ...
    private fun displayData(view: View) {
        val bloodSugarData =
            dbHelper.fetchUserId()?.let { dbHelper.getBloodSugar(it) } // Fetch the data
        ...
        headerBloodPressure.text = "Blood Sugar Level"
        ...
        if (bloodSugarData != null) {
            for (record in bloodSugarData) {
                ...
                bloodPressureTextView.text = record.bsData.toString()
